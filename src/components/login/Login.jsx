...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (!admin) {
      localStorage.setItem("admin", JSON.stringify({user: "admin", password: "admin"}))
    } else {
        ...
        <div>
          <form ref={form}>
            <div className="flex flex-col items-center">
              ...
              <input type="text" name="username" placeholder="Username" className="bg-white w-80 h-10 mt-4 p-2 rounded-lg" />
              <input type="password" name="password" placeholder="Password" className="bg-white w-80 h-10 mt-4 p-2 rounded-lg" />
